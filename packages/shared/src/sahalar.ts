...
export const SAHALAR: readonly Saha[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      block({ id: 'L-L', category: 'L', label: 'L · Sol', planLabel: 'L', side: 'L', row: 1, laneDepths: repeat(4, 8), fill: 'rowMajor' }),
      block({ id: 'L-R', category: 'L', label: 'L · Sağ', planLabel: 'L', side: 'R', row: 1, laneDepths: repeat(4, 8), fill: 'rowMajor' }),
      block({ id: 'M-L', category: 'M', label: 'M · Sol', planLabel: 'M', side: 'L', row: 2, laneDepths: repeat(4, 8), fill: 'rowMajor' }),
      block({ id: 'M-R', category: 'M', label: 'M · Sağ', planLabel: 'M', side: 'R', row: 2, laneDepths: repeat(4, 8), fill: 'rowMajor' }),
      block({ id: 'N-L', category: 'N', label: 'N · Sol', planLabel: 'N', side: 'L', row: 3, laneDepths: repeat(4, 8), fill: 'rowMajor' }),
      block({ id: 'N-R', category: 'N', label: 'N · Sağ', planLabel: 'N', side: 'R', row: 3, laneDepths: repeat(4, 8), fill: 'rowMajor' }),
      block({ id: 'O-L', category: 'O', label: 'O · Sol', planLabel: 'O', side: 'L', row: 4, laneDepths: repeat(4, 8), fill: 'rowMajor' }),
      block({ id: 'O-R', category: 'O', label: 'O · Sağ', planLabel: 'O', side: 'R', row: 4, laneDepths: repeat(4, 8), fill: 'rowMajor' }),
